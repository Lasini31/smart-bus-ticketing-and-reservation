...
function DriverEditPage({ driver, buses, onBack, onSave, onDelete }) {
  ...
  const handleDelete = () => {
    if (onDelete && window.confirm(`Are you sure you want to delete driver ${formState.name}?`)) {
      onDelete(formState.driverId);
    }
  };
    ...
    <section className="driver-edit-page">
      <div className="driver-summary-card panel">
        ...
        <div className="driver-summary-grid">
          ...
          <label>
            Email
            <input name="email" type="email" value={formState.email} onChange={handleChange} disabled={!isNewDriver} />
          </label>
      ...
      {!isNewDriver && (
        <div className="driver-payment-card panel">
          <div className="edit-actions driver-actions" style={{ justifyContent: 'space-between' }}>
